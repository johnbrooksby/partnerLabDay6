...
let compareNums = (num1, num2) => {
  ...
  // return isHigher = num1 > num2 ? num1: num2;
}

console.log(`The higher number is ${compareNums(5, 1)}.`);
...
console.log(add('23apple', '42berry'));
...
console.log(exclaimThree("John is freakin' amazing"))
...
function faveColorFinder(color){
  if (color === "red" || color === "Red" || color === "RED"){
    return colorRating = "Red is a great color";
  } else if (color === "green" || color === "Green" || color === "GREEN"){
    return colorRating = "Green is a solid favorite color";
  } else if(color === "black" || color === "Black" || color === "BLACK"){
    return colorRating = "So trendy"
  } else {
    return colorRating = "You need to evaluate your favorite color choice"
  }
}
